...
This document provides an example of the accounting made by the software during the process that leads to comsumption. 
The focus in on an indebted Consumer.
