...
Suppose, for example, you have the home directory \verb+/Users/coolcoder+. Create a temporary directory\\
\verb+mkdir repast_simphony+\\
then move to this directory\\
\verb+cd repast_simphony+\\
...
\begin{verbatim}
java -cp /Users/coolcoder/repast_simphony/repast.simphony.runtime_<version>/lib/*:
         /Users/coolcoder/repast_simphony/repast.simphony.runtime_<version>/bin 
...
\vskip1cm
Regardless of the method you use you should have the following directories tree: 
...
\verb+cd+ into the \verb+gabriele+ directory and get its absolute path  
...
move the \verb+configuration+ file from the gabriele scenario folder to the data directory:
