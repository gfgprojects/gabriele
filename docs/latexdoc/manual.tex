...
The initialization phase allows firms to determine their initial production. % reducing exogenous setting to the minimum. 
...
A numerical example of the sequence of action for a firm in {\bf bad} economic conditions can be reached by clicking \href{\doclocation/latexdoc/example_firm_bad_conditions.html}{here}
\begin{marginfigure}
\hskip8mm	\includegraphics[scale=0.07]{example.png}
\end{marginfigure}

\vskip1cm
A numerical example of the sequence of action for a firm in {\bf good} economic conditions can be reached by clicking \href{\doclocation/latexdoc/example_firm_good_conditions.html}{here}
\begin{marginfigure}
\hskip8mm	\includegraphics[scale=0.07]{example.png}
\end{marginfigure}
