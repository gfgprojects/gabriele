...
\begin{enumerate}
	...
	\item Government decides fiscal policy
	\item banks 
		\begin{enumerate}
...
\subsubsection{Office for statistics, Government and Central Ban implement fiscal policy}

{\it Office for statistics compute the taxable income and number of unemployed}
...
\noindent
{\it Consumers adjust to fiscal policy}
...
The product innovation is implemented in a very simple way\begin{marginfigure}\hskip23mm
	\includegraphics[scale=0.1]{edit.jpg}
\end{marginfigure}
