...
The reading of the above material of this document gives the idea of the state of development. However, developer need something more detailed. This more detailed information is included in the \verb+docs+ folder of GABRIELE distribution.  

Opening the \verb+index.html+ file using a browser, a web page with three sections is displayed.

The three sections are
\begin{itemize}
	\item Relationships among classes
	\item UML activity diagrams for the sequence of events
	\item javadoc API
\end{itemize}

The javadoc API documentation is standard, while the other two items represents unusual efforts in software documentation.
