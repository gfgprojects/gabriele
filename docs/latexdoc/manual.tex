...
These phases are explained in details in the \href{\doclocation/index_initialization.html}{technical documentation}. There, we present the steps taken for initializing the model in a sequential order. We also document those method that are not trivial by using UML activity diagrams.
...
The UML sequence diagram of this event is available here \href{\doclocation/umldoc/setWorkersWage.html}{here}
\begin{marginfigure}
...
A numerical example of the sequence of action of the above explained process can be reached by clicking \href{\doclocation/umldoc/example_consumer_bank_relationship.html}{here}
\begin{marginfigure}
