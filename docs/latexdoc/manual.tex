...
However, before looking at the technical documentation, some readers will probably have a look at the following sections where we discuss deeply the initialization for each type of agent.
