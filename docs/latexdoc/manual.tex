...
Check the \verb+Data Loaders+ item in the Scenario Tree. If the \verb+Context+ sub-item is reported (as in the last reported screen shot), the model can be run. Other ways, the additional settings described in next section are needed. 
