...
\gls{var:ARf} gives the position of the good in the quality ladder where higher values denote the higher quality.

The product innovation is implemented as follows
\[
