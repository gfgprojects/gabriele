...
\]
financial resources are needed to make the desired adjustment. The firm checks its internal financial resources, i.e. cash on hand and positive bank account, and if they are not enough ask for credit. 

If existing production capital is enough to realize the production, credit is also needed in case unpaid amount exists.
