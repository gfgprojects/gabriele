...
Now that the levels of both production inputs are known, the production made by each firm is computed by  using the production function (equation (\ref{eq:production_function})).
